...
function createBaseReport(args: {
  ...
  return {
    ...
    sourceClassCounts: args.graph.stats.sourceClassCounts,
    transactionalSourceSuppressionCount: args.graph.stats.transactionalSourceSuppressions,
    reviewQueueItemCount: args.graph.stats.reviewQueueItems,
    reviewQueueGroupCount: args.graph.stats.reviewQueueGroups,
    reviewQueueHighPriorityCount: args.graph.stats.reviewQueueHighPriority,
    reviewQueueMediumPriorityCount: args.graph.stats.reviewQueueMediumPriority,
    reviewQueueLowPriorityCount: args.graph.stats.reviewQueueLowPriority,
    reviewQueueMergedVariantCount: args.graph.stats.reviewQueueMergedVariants,
    reviewQueueSummarizedCandidateCount: args.graph.stats.reviewQueueSummarizedCandidates,
    reviewQueueRenderedGroupCount: args.graph.stats.reviewQueueRenderedGroups,
    reviewQueueSummarizedGroupCount: args.graph.stats.reviewQueueSummarizedGroups,
    reviewQueueCategoryCounts: args.graph.stats.reviewQueueCategoryCounts,
    promotedReviewItemCount: args.graph.stats.promotedReviewItems,
    postCompactionPromotedReviewItemCount: args.graph.stats.postCompactionPromotedReviewItems,
